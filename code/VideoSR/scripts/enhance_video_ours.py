...
def main():
    ...
    for ind, file_path in enumerate(file_path_list):
        ...
        os.system('/ai-video-sh/haoxiang.guo/HoloTime/ffmpeg-7.0.2-amd64-static/ffmpeg -i {} -vf scale=768:384 {}'.format(file_path, file_path.replace('_out.mp4', '_resize.mp4')))
    ...
    for ind, file_path in enumerate(file_path_list):
        file_path = file_path.replace('_out.mp4', '_resize.mp4')
