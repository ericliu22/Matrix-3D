...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from):
    ...
    for iteration in range(first_iter, opt.iterations + 1):        
        ...
        is_save_images = True# False # default to not save images
        if is_save_images and (iteration % opt.densification_interval == 1):
            with torch.no_grad():
        ...
        with torch.no_grad():
            ...
            if iteration < opt.densify_until_iter:
                # print(f"densification: {iteration} {opt.densification_interval} {opt.densify_from_iter} {opt.densify_until_iter}")
