...
class ModelParams(ParamGroup): 
    def __init__(self, parser, sentinel=False):
        ...
        # define number of point from depth and interpolation frames
        self.img_sample_interval = 9
        self.num_views_per_view = 20
        self.num_of_point_cloud = 5000_000
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.lambda_depth_normal = 0.025
        self.distortion_from_iter = 1000
        # self.distortion_from_iter = 0
        self.depth_normal_from_iter = 1000
