...
huggingface-cli download \
  --repo-id bert-base-uncased \
  --filename config.json \
  --local-dir ./my_model
python scripts/sr_val_ddpm_text_T_vqganfin_old.py --config configs/stableSRNew/v2-finetune_text_T_512.yaml --ckpt ./ckpt/stablesr_turbo.ckpt --init-img /ai-video-sh/zhongqi.yang/code/zhongqi.yang/panorama_training/StableSR/inputs/test_example/OST_120.png --outdir /ai-video-sh/zhongqi.yang/code/zhongqi.yang/panorama_training/StableSR/inputs/test_example/OST_120_sr.png --ddpm_steps 4 --dec_w 0.5 --seed 42 --n_samples 1 --vqgan_ckpt ./ckpt/vqgan_cfw_00011.ckpt --colorfix_type wavelet
'''
